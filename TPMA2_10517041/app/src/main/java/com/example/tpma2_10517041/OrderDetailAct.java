    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnmines.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                total_bayar.setText("Rp. "+valuetotalharga+"");
            }
        });
        ...
        reference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                kategori_produk.setText(dataSnapshot.child("kategori_produk").getValue().toString());
                nilai_produk.setText(dataSnapshot.child("nilai_produk").getValue().toString());
                harga_produk.setText("Rp. "+dataSnapshot.child("harga_produk").getValue().toString());
                ...
                deskripsi_produk.setText(dataSnapshot.child("deskripsi_produk").getValue().toString());
                Picasso.with(OrderDetailAct.this).load(dataSnapshot.child("url_thumbnail").getValue().toString()).centerCrop().fit().into(header_order_detail);
            }
